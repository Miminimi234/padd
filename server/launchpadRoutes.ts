...
// Padd Platform Configuration - deployed on devnet
const Padd_PLATFORM_CONFIG_ID = '9s82BCAuWCtXub1MytzfH93LG2cRM41YEF8CYTZpc8w5';
    ...
    try {
        ...
        return res.json({
            ...
            data: {
                ...
                launchpadConfigId: Padd_PLATFORM_CONFIG_ID,
                mint: {
 ...
 * Get Padd platform configuration info
 */
router.get('/config', async (req, res) => {
    try {
        const config = {
            platformConfigId: Padd_PLATFORM_CONFIG_ID,
            ...
            platform: {
                name: 'Padd',
                website: 'https://Padd.trade',
                logo: 'https://i.ibb.co/230s7Rw5/Paddlogo.png',
