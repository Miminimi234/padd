...
// Tax destination address for Padd
export const Padd_TAX_DESTINATION = new PublicKey("84ngZsUwXqApU79awKcT2CVLufApUf1NiaTPbAKhngy1");
...
/**
 * Create a Padd bonding curve configuration using Meteora DBC
 */
export async function createPaddBondingConfig(
