...
if (txBuilderProto && !txBuilderProto.__PaddSizeLoggerPatched) {
    ...
    txBuilderProto.__PaddSizeLoggerPatched = true;
}
...
export class RaydiumClientSDK {
    ...
    async createLaunchpad(params: LaunchpadCreateParams, userWallet: any) {
        ...
        const platformIdStr = import.meta.env.VITE_Padd_PLATFORM_CONFIG_ID ||
            "9s82BCAuWCtXub1MytzfH93LG2cRM41YEF8CYTZpc8w5";

        console.log("[DEBUG] Platform ID from env:", import.meta.env.VITE_Padd_PLATFORM_CONFIG_ID);
        console.log("[DEBUG] Using platform ID:", platformIdStr);

        const PaddPlatformId = new PublicKey(platformIdStr);
        ...
        try {
            ...
            const createParams = {
                ...
                platformId: PaddPlatformId, // Always include platformId
