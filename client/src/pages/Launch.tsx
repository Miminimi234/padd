...
const steps = [
  ...
  { number: 3, title: "Deploy", subtitle: "Launch your Padd" },
];
...
export default function Launch() {
  ...
  const triggerLoginModal = () => {
    if (typeof window !== "undefined") {
      window.dispatchEvent(new Event("Padd-open-login-modal"));
    }
  };
  ...
  const generateMetadata = async (): Promise<string | null> => {
    ...
    try {
      const result = await generateLaunchpadMetadata({
        ...
        attributes: [
          { trait_type: "Platform", value: "Padd" },
    ...
    try {
      ...
      try {
        const metadataResult = await generateLaunchpadMetadata({
          name: trimmedName,
          symbol: trimmedSymbol,
          description: formData.basics.description || `${trimmedName} - Launched on Padd`,
        ...
        toast({
          ...
          description: "Using default Padd metadata. Launch will continue.",
          variant: "destructive",
        });
        // Use fallback metadata URI
        metadataUri = 'https://Padd.trade/token-metadata.json';
      ...
      toast({
        ...
        description: `Your ${trimmedSymbol} token is now live on Padd with Raydium LaunchLab!`,
      });
      ...
      console.error("Padd deployment failed:", error);
      toast({
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <p className="text-muted-foreground">
          {launchMode === "lev"
            ? "Launch Padds for any token on the Solana chain"
            : "Launch Padd native tokens to Raydium LaunchLab"}
        </p>
        ...
        <>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            <Card className="p-6 border-card-border bg-card space-y-6">
              <div>
                <h2 className="text-2xl font-bold mb-2 text-foreground">Padd Lev Deployment</h2>
                <p className="text-sm text-muted-foreground">
                  Configure leveraged Padd parameters before requesting a Meteora pool.
                </p>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="lev-duration">Padd Lifecycle</Label>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-2">
                    ...
                    <Label htmlFor="lev-terms" className="text-sm text-muted-foreground">
                      I agree to the terms of creating a Padd.
                    </Label>
                  </div>
                  <Button
                    type="button"
                  ...
                  <p className="text-xs text-muted-foreground">
                    First-time Padd launchers require manual approval. Submit an application to begin the review process.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6 border-card-border bg-card space-y-4">
              <h3 className="text-lg font-semibold text-foreground">What is Padd Lev?</h3>
              <p className="text-sm text-muted-foreground">
                Padd Lev uses Meteora&apos;s dynamic liquidity pools to unlock leverage against your Padd positions.
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                ...
                <p>Need the classic bonding curve experience? Switch back to <span className="text-primary">Deploy Padd Token</span>.</p>
              </div>
            </Card>
          </div>
              ...
              <div className="p-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <DialogTitle className="text-xl font-semibold text-foreground">
                        {hasSubmittedAccessRequest ? "Application Submitted" : "Padd Provider Verification"}
                      </DialogTitle>
                      <DialogDescription className="text-sm text-muted-foreground leading-relaxed">
                        {hasSubmittedAccessRequest
                          ? "Your wallet has been logged for review. Our team will reach out as soon as you’re approved to create Padds."
                          : "For the protection of traders and liquidity providers, every wallet must be vetted before creating Padds."}
                      </DialogDescription>
                    </div>
                  </div>
                </DialogHeader>
                ...
                {!hasSubmittedAccessRequest ? (
                  <div className="mt-6 space-y-4 text-sm">
                    <div className="rounded-lg border border-border/50 bg-muted/10 p-4 space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            We review wallet history for suspicious activity before enabling Padd creation.
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                    ...
                    <p className="text-muted-foreground">
                      Submit your wallet for review to unlock Padd Lev deployments as soon as access is granted.
                    </p>
                  </div>
                ) : (
                  <div className="mt-6 space-y-4 text-sm">
              ...
              <Card className="p-6 border-card-border bg-card min-h-[500px]">
                <AnimatePresence mode="wait">
                  ...
                  {currentStep === 1 && (
                    ...
                    >
                      <div>
                        <h2 className="text-2xl font-bold mb-2 text-foreground">Padd Basics</h2>
                        <p className="text-sm text-muted-foreground">Set up your Padd identity</p>
                      </div>

                      <div className="space-y-4">
                        <div>
                          <Label htmlFor="name">Padd Name</Label>
                          <Input
                            id="name"
                        ...
                        <div>
                          ...
                          <textarea
                            id="description"
                            placeholder="Describe your Padd..."
                        ...
                        <div>
                          <Label>Padd Image (optional)</Label>
                          <div className="mt-2">
                            {imagePreview ? (
                  ...
                  {currentStep === 3 && (
                    ...
                    >
                      <div>
                        <h2 className="text-2xl font-bold mb-2 text-foreground">Deploy Your Padd</h2>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            <span className="text-muted-foreground">Padd Name</span>
                ...
                {formData.basics.symbol ? (
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{formData.basics.name || "Your Padd name"}</p>
                  ...
                  <div className="text-center py-8">
                    <p className="text-sm text-muted-foreground">
                      Fill in Padd details to see preview
                    </p>
                  </div>
                )}
              </Card>
